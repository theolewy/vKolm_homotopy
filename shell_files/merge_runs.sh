...
#SBATCH --output=slurm_merge_%A.out
#SBATCH --nodes=1
#SBATCH -J merge_vKolm
#SBATCH --ntasks=1
...
application="python $HOME/projects/vKolm_homotopy/merge_runs.py"

#! Work directory (i.e. where the job will run):
workdir="$HOME/projects/vKolm_homotopy/"  # The value of SLURM_SUBMIT_DIR sets workdir to the directory
